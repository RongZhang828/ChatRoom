...
public class ServerLayout {
	...
	public static String windowName = "服务端";
	...
	public static String clientText = "服务端";
	public static String connBtnName = "启动";
	public static String exitBtnName = "关闭";
	...
	public SetLayout getServerLayout(){
		return this.lo;
	}
